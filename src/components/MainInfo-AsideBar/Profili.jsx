...
const Profili = ({ epicProfile }) => {
  ...
  return (
    <Row className="p-2">
      ...
      <Col className="p-0">
        <a className="m-0 fs-6 d-block text-dark fw-bold link-underline link-underline-opacity-0 link-underline-opacity-75-hover" onClick={() => dispatch(selectProfileAction(epicProfile))}>
