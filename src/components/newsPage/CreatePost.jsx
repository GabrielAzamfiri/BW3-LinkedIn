      ...
      {profile && (
        <div className="createPost-container">
          <div className="createPost-input">
            <img src={profile.image} alt="User Avatar" className="createPost-avatar" />
            <ModalCreatePost />
          </div>
          <div className="createPost-options">
            <div className="option-createPost">
              ...
              <span className="createLeft">Contenuti </span>
            </div>
            <div className="option-createPost">
