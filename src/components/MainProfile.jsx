      ...
      <Card className=" position-relative rounded">
        <div className="position-relative">
          ...
          <Button
            id="pencil"
            variant="transparent"
            className="rounded-circle bg-white position-absolute top-0 end-0 d-flex align-items-center justify-content-center me-4 mt-4 py-3"
          >
          ...
          <Button
            id="pencil"
            variant="transparent"
            className="rounded-circle h-25 position-absolute top-100 end-0 d-flex align-items-center justify-content-center me-4 mt-4 "
          >
        ...
        <img
          ...
          src={profile.image}
          alt="profile image"
          className="rounded-circle border border-5 border-white position-absolute"
          width={160}
        />
        <Row className="pt-5 mt-4 px-4  ">
            ...
            <Card.Body className="lh-sm">
              <div className="d-flex">
                ...
                <Button
                  ...
                  className="mx-2 rounded-pill d-flex align-items-center fw-bold "
                >
              ...
              <Card.Text>
                <span className="opacity-75 me-3 lead fs-6">
                  {" "}
                  {profile.area}
                </span>
                <a
                  className="fw-bold link-underline link-underline-opacity-0 link-underline-opacity-75-hover"
                  href="#"
                >
          ...
          <Col
            xs={4}
            className="d-flex mt-4 align-items-center justify-content-end "
          >
            <a
              href="https://www.linkedin.com/school/epicodeitalia/"
              className="btn"
            >
              <img
